(function(){System.register([`./embedpdf-7TNsu-EA-legacy-B_ffnUGy.js`,`./browser-BKLM0ThC-CkSOgtCM-legacy-g8XVc1WU.js`],function(e,t){var n,r,i,a,o,s,c,l,u,d,f,p,m;function h(e,t){let{logger:n,encoderPoolSize:r,fontFallback:i}=t instanceof Object&&`debug`in t?{logger:t}:t||{},a=new Worker(URL.createObjectURL(new Blob([`var Rotation = /* @__PURE__ */ ((Rotation2) => {
